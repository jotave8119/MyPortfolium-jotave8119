  ...
  return (
    <section className="aboutBox" id="about">
      ...
      <p className="aboutText" title="Leia com Carinho 🥰">
        ...
        projetos individuais e em equipe. Foi muito gratificante. Hoje estou no
        primeiro semestre de Análise e desenvolvimento de sistemas pela UNOPAR.
        Apesar de estar há pouco tempo na área, há alguns anos a área da
        tecnologia foi me atraindo aos poucos. O mundo do desenvolvimento me dá
        a sensação de pertencer e fazer parte de algo realmente grande e
        inovador. Os desafios são constantes, mas me apaixono por este mundo
